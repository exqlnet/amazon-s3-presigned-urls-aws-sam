...
exports.handler = async (event) => {
  ...
  return await getUploadURL(contentType);
}

const getUploadURL = async function(contentType) {
  ...
  const Key = `${randomID}.${extension}`; // Constructing objectKey using randomID and extension
